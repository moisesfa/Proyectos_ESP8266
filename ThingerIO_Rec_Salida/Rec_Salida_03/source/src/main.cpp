...
// Pin DONE para controlar el TPL5110
#define PIN_DONE 14
...
void loop() {
  ...
  Serial.println("Control Done del TPL5110 APAGAR");
  // cambiar DONE para que TPL sepa cortar la energía!
  while (1) {
